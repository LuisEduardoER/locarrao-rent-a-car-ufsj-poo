...
/*
 * VisaoRelatorioLocacaoesFinalizadas.java
 *
 * Created on 24/11/2011, 22:07:52
 */
...
public class VisaoRelatorioLocacaoesFinalizadas extends javax.swing.JFrame {
    ...
    public VisaoRelatorioLocacaoesFinalizadas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new VisaoRelatorioLocacaoesFinalizadas().setVisible(true);
            }
        });
    }
    ...
    public void criarRelatorio(){
        ...
        if(verificarCamposEmBranco()){
            if(verificarCamposDatas()){
                lista = persisteLocacao.retornarLocacoesFinalizadasDB();
                
            }else{
                lista = persisteLocacao.retornarLocacoesFinalizadasDB(jDateInicial.getDate(),
                        jDateFinal.getDate());
            }
